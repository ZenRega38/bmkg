...
<?php include 'header.php'; ?>
    ...
    <div class="year-navigation" style="display: flex; justify-content: center;">
          <img id="prevYearBtn" class="swiper-button-prev" src="assets/image/prev_btn.png">
          <span style="align-items: center; display: flex; justify-content: center;" id="currentYearDisplay"></span>
