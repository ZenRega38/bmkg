...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .shakemap {
                width: 90%; /* Make the image take up more width */
            ...
            .badge {
              margin-bottom: 10px; /* Move the badge above the image */
            }
            ...
            .stats {
                justify-content: center; /* Center the stat boxes */
            }

            .stat-box {
                flex: 1 1 calc(50% - 15px); /* Two stat boxes per row */
            }

            .link-selengkapnya {
                font-size: 1.1em; /* Make the link text a bit larger */
            }
        }
    </style>
</head>
